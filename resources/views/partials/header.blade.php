  <div class="row bg-white">
      ...
      @if (Route::is('home'))
          <div class="col-3 py-2 mt-2">
              <div class="d-inline-block m-4 p-2"><a class="text-black text-decoration-none" href="#em-destaque">PRODUTOS
                      EM DESTAQUE</a></div>
              <div class="d-inline-block m-4 p-2"><a class="text-black text-decoration-none"
                      href="#categorias">CATEGORIAS</a></div>
          </div>
      @else
      <div class="col-3 py-2 mt-2"></div> 
      @endif
